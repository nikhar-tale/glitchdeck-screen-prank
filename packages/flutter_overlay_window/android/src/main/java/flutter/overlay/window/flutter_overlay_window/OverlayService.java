...
public class OverlayService extends Service implements View.OnTouchListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Only call moveOverlay if start coordinates are custom, as default coordinates are already
        // applied via params (x=0, y=-statusBarHeightPx) in physical pixels to prevent double-conversion.
